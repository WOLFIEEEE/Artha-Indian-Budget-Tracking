...
struct ContentView: View {
    ...
    @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var colourScheme: Int = 0
    @Environment(\.scenePhase) var scenePhase
    @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var showNotifications: Bool = false
    @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var notificationsEnabled: Bool = true

    @AppStorage("firstLaunch", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var firstLaunch: Bool = true

    // adds category orders
    @AppStorage("dataMigration1", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var dataMigration1: Bool = true

    // converts category colors to hex codes
    @AppStorage("dataMigration2", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var dataMigration2: Bool = true

    @AppStorage("currency", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var currency: String = Locale.current.currencyCode!
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var showUpdateSheet: Bool = true
    ...
    var body: some View {
        ...
        .onAppear {
//            UserDefaults(suiteName: "group.com.arthaapp.artha")!.set(false, forKey: "newTransactionAdded")
//            WidgetCenter.shared.reloadTimelines(ofKind: "TemplateTransactions")
            ...
            let defaults =
                UserDefaults(suiteName: "group.com.arthaapp.artha") ?? UserDefaults.standard
