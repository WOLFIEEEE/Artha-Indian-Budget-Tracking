...
struct TemplateTransactionView: View {
    ...
    @AppStorage("numberEntryType", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var numberEntryType: Int = 1

    @Environment(\.colorScheme) var colorScheme

    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var topEdge: Double = 30
    ...
    @AppStorage("firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var firstLaunch: Bool = true
