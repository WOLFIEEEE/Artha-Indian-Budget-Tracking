...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.arthaapp.artha"))
  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: "group.com.arthaapp.artha")!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(
        forKey: "customMinute")
