...
struct InsightsView: View {
    ...
    @AppStorage("chartTimeFrame", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var chartType = 1
...
struct HorizontalPieChartView: View {
    ...
    init(date: Date, categoryFilter: Binding<Category?>?, categoryFilterMode: Binding<Bool>, selectedDate: Binding<Date?>?, chosenAmount: Binding<Double>, chosenName: Binding<String>, type: ChartTimeFrame, income: Bool) {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(forKey: "firstWeekday")
...
struct SingleGraphView: View {
    ...
    @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var incomeTracking: Bool = true
    ...
    @AppStorage("firstDayOfMonth", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var firstDayOfMonth: Int = 1
...
//        return abs(offset) > UIScreen.main.bounds.width * 0.3
    ...
    @AppStorage("insightsViewIncomeFiltering", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var income: Bool = true
    @AppStorage("incomeTracking", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var incomeTracking: Bool = true
...
//    @AppStorage("animated", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var animated: Bool = true
