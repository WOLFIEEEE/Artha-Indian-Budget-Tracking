...
struct LogView: View {
    ...
    @AppStorage("showCents", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var showCents: Bool = true
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsTimeFrame", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var timeframe = 2
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var lineGraph: Bool = false
    ...
    var range: Int {
        ...
        calendar.firstWeekday = UserDefaults(suiteName: "group.com.arthaapp.artha")?.integer(forKey: "firstWeekday") ?? 0
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var showSoon: Bool = false
...
struct ListView: View {
    ...
    @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var swapTimeLabel: Bool = false
...
struct DeleteTransactionAlert: View {
    ...
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.arthaapp.artha")) var bottomEdge: Double = 15
