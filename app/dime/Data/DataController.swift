...
//        } else {
//            description.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.com.arthaapp.artha")
//        }

        description.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.com.arthaapp.artha")

        let groupID = "group.com.arthaapp.artha"
...
////        }
    ...
    var addedTransaction: Bool {
        get {
            UserDefaults(suiteName: "group.com.arthaapp.artha")!.bool(forKey: "newTransactionAdded")
        }

        set {
            UserDefaults(suiteName: "group.com.arthaapp.artha")!.set(newValue, forKey: "newTransactionAdded")
        }
    }
    ...
    func fetchRequestForLogView(type: Int, optionalIncome: Bool?, categoryFilters: [Category] = []) -> NSFetchRequest<Transaction> {
        ...
        if type == 5 {
            ...
            if type == 1 {
                ...
                let startOfMonth = UserDefaults(suiteName: "group.com.arthaapp.artha")!.integer(forKey: "firstDayOfMonth")
